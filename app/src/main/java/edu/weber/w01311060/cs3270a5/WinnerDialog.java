...
public class WinnerDialog extends DialogFragment
{
     ...
     * @return A new instance of fragment WinnerDialog.
     */
    // TODO: Rename and change types and number of parameters
    public static WinnerDialog newInstance(String param1, String param2)
    {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState)
    {
        ...
        builder.setTitle("You did it!")
                .setMessage("You were able to make the correct change.")
